...
<html>
  <head>
    ...
    <link type="text/css" href="//cdn.jsdelivr.net/npm/@graphql-helix/graphiql@latest/dist/graphiql.min.css" rel="stylesheet" ${nonceAttribute}/>
    <link
      rel="icon"
      type="image/svg+xml"
      ...
      ${nonceAttribute}
    />
    <script src="//cdn.jsdelivr.net/npm/@graphql-helix/graphiql@latest/dist/graphiql.min.js" ${nonceAttribute}></script>
